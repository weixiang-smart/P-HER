...
from baselines.her.her import make_sample_her_transitions, \
                              make_sample_her_transitions_motivation
# some params
DEFAULT_ENV_PARAMS = {
    'FetchReach-v0': {
        'n_cycles': 10,
...
def configure_her(params):
    ...
    for name in ['replay_strategy', 'replay_k', 'ratio', 'ratio_o']:
        her_params[name] = params[name]
        params['_' + name] = her_params[name]
        del params[name]
    if params['prioritization'] == 'motivation':
        sample_her_transitions = make_sample_her_transitions_motivation(**her_params)
    else:
